...
constexpr int SCRIPT_EVENT_SOUND = 1004;			//!< Play named wave file (on SoundChannel::Body)
...
constexpr int SCRIPT_EVENT_SOUND_VOICE = 1008;		//!< Play named wave file (on SoundChannel::Voice)

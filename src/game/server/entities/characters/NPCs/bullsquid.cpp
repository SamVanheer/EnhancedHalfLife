...
void CBullsquid::IdleSound()
{
	...
	{
	case 0:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle1.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 1:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle2.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 2:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle3.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 3:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle4.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	case 4:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle5.wav", VOL_NORM, SQUID_ATTN_IDLE);
		break;
	}
}
...
void CBullsquid::PainSound()
{
	...
	{
	case 0:
		EmitSound(CHAN_VOICE, "bullchicken/bc_pain1.wav", VOL_NORM, ATTN_NORM, iPitch);
		break;
	case 1:
		EmitSound(CHAN_VOICE, "bullchicken/bc_pain2.wav", VOL_NORM, ATTN_NORM, iPitch);
		break;
	case 2:
		EmitSound(CHAN_VOICE, "bullchicken/bc_pain3.wav", VOL_NORM, ATTN_NORM, iPitch);
		break;
	case 3:
		EmitSound(CHAN_VOICE, "bullchicken/bc_pain4.wav", VOL_NORM, ATTN_NORM, iPitch);
		break;
	}
}
...
void CBullsquid::AlertSound()
{
	...
	{
	case 0:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle1.wav", VOL_NORM, ATTN_NORM, iPitch);
		break;
	case 1:
		EmitSound(CHAN_VOICE, "bullchicken/bc_idle2.wav", VOL_NORM, ATTN_NORM, iPitch);
		break;
	}
}
...
//			pev->velocity.z += (0.875 * flGravity) * 0.5;
	...
	case BSQUID_AE_THROW:
	{
		...
		if (CBaseEntity* pHurt = CheckTraceHullAttack(70, 0, 0); pHurt)
		{
			...
			{
			case 0:
				EmitSound(CHAN_WEAPON, "bullchicken/bc_bite2.wav", VOL_NORM, ATTN_NORM, iPitch);
				break;
			case 1:
				EmitSound(CHAN_WEAPON, "bullchicken/bc_bite3.wav", VOL_NORM, ATTN_NORM, iPitch);
				break;
			}
...
void CBullsquid::DeathSound()
{
	...
	{
	case 0:
		EmitSound(CHAN_VOICE, "bullchicken/bc_die1.wav");
		break;
	case 1:
		EmitSound(CHAN_VOICE, "bullchicken/bc_die2.wav");
		break;
	case 2:
		EmitSound(CHAN_VOICE, "bullchicken/bc_die3.wav");
		break;
	}
}
...
void CBullsquid::AttackSound()
{
	...
	{
	case 0:
		EmitSound(CHAN_WEAPON, "bullchicken/bc_attack2.wav");
		break;
	case 1:
		EmitSound(CHAN_WEAPON, "bullchicken/bc_attack3.wav");
		break;
	}
}
...
void CBullsquid::StartTask(Task_t* pTask)
{
	...
	case TASK_MELEE_ATTACK2:
	{
		...
		{
		case 0:
			EmitSound(CHAN_VOICE, "bullchicken/bc_attackgrowl.wav");
			break;
		case 1:
			EmitSound(CHAN_VOICE, "bullchicken/bc_attackgrowl2.wav");
			break;
		case 2:
			EmitSound(CHAN_VOICE, "bullchicken/bc_attackgrowl3.wav");
			break;
		}

...
// stuff written for new state machine
		...
		// virtual int CanPlaySequence() { return ((m_pCine == nullptr) && (m_MonsterState == MONSTERSTATE_NONE || m_MonsterState == MONSTERSTATE_IDLE || m_IdealMonsterState == MONSTERSTATE_IDLE)); }

...
constexpr int bits_SQUAD_FLANK_LEFT = 1 << 0;
constexpr int bits_SQUAD_FLANK_RIGHT = 1 << 1;
constexpr int bits_SQUAD_ADVANCE = 1 << 2;
constexpr int bits_SQUAD_FLUSH_ATTACK = 1 << 3;

...
void CBasePlayer::Killed( entvars_t *pevAttacker, int iGib )
{
	...
	SetSuitUpdate(NULL, SuitSoundType::Sentence, 0);
...
// add sentence to suit playlist queue. if type is SuitSoundType::Group, then
...
void CBasePlayer :: FlashlightTurnOn()
{
	...
	if ( (pev->weapons & (1<<WEAPON_SUIT)) )
	{
		EMIT_SOUND_DYN( ENT(pev), CHAN_WEAPON, SOUND_FLASHLIGHT_ON.data(), 1.0, ATTN_NORM, 0, PITCH_NORM );

...
void CBaseDoor::Precache()
{
	...
	default: m_ls.sLockedSentence = string_t::Null; break;
	}
	...
	default: m_ls.sUnlockedSentence = string_t::Null; break;
	}
}
...
void CBaseDoor::DoorTouch(CBaseEntity* pOther)
{
	...
	if (!IsStringNull(m_iszMaster) && !UTIL_IsMasterTriggered(m_iszMaster, pOther))
...
{
	if (!UTIL_IsMasterTriggered(m_iszMaster, m_hActivator))
		return false;
